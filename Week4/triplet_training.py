...
loss_names = {
          "Triplet Margin": losses.TripletMarginLoss,
          "Margin": losses.MarginLoss,
}


mine_strategy = ["hard", "semihard", "all"]

combs = itertools.product(list(distance_names.keys()), list(loss_names.keys()), mine_strategy)
...
for comb in combs:
    ...
    loss_func = loss_names[comb[1]](margin=0.2, distance=distance, reducer=reducer)
    ...
    with open("triplet_fine_res.pkl", "wb") as f:
